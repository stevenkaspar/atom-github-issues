...
export default class GithubView {
    ...
    constructor(path) {
        ...
        if(gc.username && gc.token){
            ...
            atom.notifications.addSuccess('No Github Access Token found. To view Private repositories or to post comments, please add your Github Access Token with \'git config user.accesstoken "GITHUB_ACCESS_TOKEN"\'', {dismissable: true});
...
class Assignees extends React.Component {
    ...
    routeAssignee(){
        ...
        var html_string = '<span class="icon icon-smiley"></span>';
...
class AssigneeModal extends React.Component {
    ...
    handleChange(e){
        ...
        github[action](gc, endpoint, data).then((function(response_body){
